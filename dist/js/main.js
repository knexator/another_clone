...
void main(void) {
    ...
    `,ls=class extends ve{get vertexCode(){return Gu}get fragmentCode(){return Wu}get uniformTypes(){return{texture:{type:ve.UniformTypes.Texture,bind:ve.UniformBinds.MainTexture},projection:{type:ve.UniformTypes.Matrix,bind:ve.UniformBinds.Projection},world:{type:ve.UniformTypes.Matrix,bind:ve.UniformBinds.World}}}get attributeTypes(){return{position:{size:3,type:ve.AttributeTypes.Float,normalize:!1,bind:ve.AttributeBinds.Position},coord:{size:2,type:ve.AttributeTypes.Float,normalize:!1,bind:ve.AttributeBinds.TextureCoords},color:{size:4,type:ve.AttributeTypes.Float,normalize:!1,bind:ve.AttributeBinds.Colors}}}};Oo.exports=ls});var Io=y((e_,Lo)=>{"use strict";var Ee=Tt(),Xu=`#version 300 es
in vec3 a_position;
in vec2 a_coord;
in vec4 a_color;
...
}`,yr=class extends we.default{get vertexCode(){return vc}get fragmentCode(){return Ec}get uniformTypes(){return{u_projection:{type:we.default.UniformTypes.Matrix,bind:we.default.UniformBinds.Projection},u_world:{type:we.default.UniformTypes.Matrix,bind:we.default.UniformBinds.World},u_time:{type:we.default.UniformTypes.Float,bind:"u_time"},u_aspect_ratio:{type:we.default.UniformTypes.Float,bind:"u_aspect_ratio"},u_alpha:{type:we.default.UniformTypes.Float,bind:"u_alpha"},u_dark:{type:we.default.UniformTypes.Float,bind:"u_dark"}}}get attributeTypes(){return{a_position:{size:3,type:we.default.AttributeTypes.Float,normalize:!1,bind:we.default.AttributeBinds.Position},a_coord:{size:2,type:we.default.AttributeTypes.Float,normalize:!1,bind:we.default.AttributeBinds.TextureCoords}}}};var Ae=xe(Tt()),Tc=`#version 300 es
in vec3 a_position;
in vec2 a_coord;
...
}`,br=class extends Ae.default{get vertexCode(){return Tc}get fragmentCode(){return Sc}get uniformTypes(){return{u_projection:{type:Ae.default.UniformTypes.Matrix,bind:Ae.default.UniformBinds.Projection},u_world:{type:Ae.default.UniformTypes.Matrix,bind:Ae.default.UniformBinds.World},u_screen_size:{type:Ae.default.UniformTypes.Float2,bind:"u_screen_size"},u_progress:{type:Ae.default.UniformTypes.Float,bind:"u_progress"},u_pos:{type:Ae.default.UniformTypes.Float2,bind:"u_pos"}}}get attributeTypes(){return{a_position:{size:3,type:Ae.default.AttributeTypes.Float,normalize:!1,bind:Ae.default.AttributeBinds.Position},a_coord:{size:2,type:Ae.default.AttributeTypes.Float,normalize:!1,bind:Ae.default.AttributeBinds.TextureCoords}}}};var Ac=1/4,Cc=2.5,Rc=.15,fn=.4,E=50,S=50,xn=.6,dt={time:"MANUAL",instant_reset:!0},kr=new zl({});kr.remember(dt);kr.add(dt,"time",["MANUAL","SEMI","AUTO"]);kr.add(dt,"instant_reset");kr.hide();u.default.input.setTargetElement(()=>u.default.gfx.canvas);await u.default.init();document.body.appendChild(u.default.gfx.canvas);u.default.gfx.setResolution(800,600,!0);u.default.gfx.centerCanvas();u.default.startFrame();u.default.gfx.clear(u.default.utils.Color.darkslategray);u.default.endFrame();var pt=new d.default(800,430),Tr=!1,_n=!1,ki=P.default.fromHex("#47B2CE"),Ot=(0,Wl.default)((r,e,t,i=32,s=P.default.white,n=ae.TextAlignments.Center,o=Le)=>{console.log("building text");let a=u.default.gfx.buildText(o,r,i,s,n);return a.position.set(e,t),a},(r,e,t)=>r+e.toString()+t.toString()),Le=u.default.assets.loadMsdfFontTexture("fonts/Arial.ttf",{jsonUrl:"fonts/Arial.json",textureUrl:"fonts/Arial.png"}).asset,Fi=u.default.assets.loadMsdfFontTexture("fonts/BowlbyOne-Regular.ttf",{jsonUrl:"fonts/BowlbyOne-Regular.json",textureUrl:"fonts/BowlbyOne-Regular.png"}).asset;await u.default.assets.waitForAll();var ke=new L.default(u.default.gfx.whiteTexture);ke.origin=d.default.zero;ke.size.set(800,600-pt.y);ke.position.set(0,pt.y);ke.color=P.default.fromHex("#2B849C");var Oi=new L.default(u.default.gfx.whiteTexture);Oi.origin=d.default.zero;Oi.size.set(800,8);Oi.position.set(0,pt.y);Oi.color=P.default.fromHex("#12679B");var yn=Ot("Another",400,10,136,ki,ae.TextAlignments.Center,Fi),bn=Ot("Clone",400,136,136,ki,ae.TextAlignments.Center,Fi),vn=Ot("Loading...",400,490,48,P.default.white,ae.TextAlignments.Center,Le);u.default.startFrame();u.default.gfx.clear(u.default.utils.Color.darkslategray);u.default.gfx.drawSprite(ke);u.default.gfx.drawSprite(Oi);u.default.gfx.useEffect(u.default.gfx.builtinEffects.MsdfFont);u.default.gfx.drawGroup(yn,!1);u.default.gfx.drawGroup(bn,!1);u.default.gfx.drawGroup(vn,!1);u.default.endFrame();var vr=Ot("Press any key to start",400,490,48,P.default.white,ae.TextAlignments.Center,Le),Ll=new u.default.utils.Storage,Ie=6,Ve=125,ft=100,Cr=(pt.x-Ve*(Ie-1)-ft)*.5,Rr=(pt.y-Ve*2-ft)*.5,Mc=u.default.assets.loadTexture("imgs/directions.png",{generateMipMaps:!0}).asset,Bc=u.default.assets.loadTexture("imgs/spacebar.png",{generateMipMaps:!0}).asset,kc=u.default.assets.loadTexture("imgs/undo_redo.png",{generateMipMaps:!0}).asset,Fc=u.default.assets.loadTexture("imgs/mute.png",{generateMipMaps:!0}).asset,Dc=u.default.assets.loadTexture("imgs/reset.png",{generateMipMaps:!0}).asset,Pc=u.default.assets.loadTexture("imgs/player.png",{generateMipMaps:!0}).asset,Oc=u.default.assets.loadTexture("imgs/player_gray.png",{generateMipMaps:!0}).asset,zc=u.default.assets.loadTexture("imgs/crate.png",{generateMipMaps:!0}).asset,Lc=u.default.assets.loadTexture("imgs/target.png",{generateMipMaps:!0}).asset,Ic=u.default.assets.loadTexture("imgs/button.png",{generateMipMaps:!0}).asset,Yl=u.default.assets.loadTexture("imgs/particle_crate.png",{generateMipMaps:!0}).asset,Nc=u.default.assets.loadTexture("imgs/geo.png",{generateMipMaps:!0}).asset,qc=u.default.assets.loadTexture("imgs/spawner.png",{generateMipMaps:!0}).asset,Il=u.default.assets.loadTexture("imgs/floors.png",{generateMipMaps:!0}).asset,Uc=u.default.assets.loadTexture("imgs/left_arrow.png",{generateMipMaps:!0}).asset,Hc=u.default.assets.loadTexture("imgs/wait.png",{generateMipMaps:!0}).asset,Fn=u.default.assets.loadTexture("imgs/tape_borders.png",{generateMipMaps:!0}).asset,jc=u.default.assets.loadTexture("icons/all.png").asset,Vc=u.default.assets.loadTexture("icons/icon_back.png").asset,Gc=u.default.assets.loadTexture("icons/icon_border.png").asset,Wc=u.default.assets.loadSound("sounds/step.wav").asset,Xc=u.default.assets.loadSound("sounds/push.wav").asset,Yc=u.default.assets.loadSound("sounds/wall.wav").asset,$c=u.default.assets.loadSound("sounds/onTarget.wav").asset,Kc=u.default.assets.loadSound("sounds/offTarget.wav").asset;await u.default.assets.waitForAll();var ti=new L.default(Mc,new oe.default(0,0,150,100)),$e=new L.default(Bc),ii=new L.default(kc,new oe.default(0,0,200,50)),Zt=new L.default(Fc,new oe.default(0,50,100,50));Zt.position.set(725,550);var $l=new L.default(Dc);$l.position.set(600,550);var En=new L.default(Pc);En.size.set(E,E);var Kl=new L.default(Oc);Kl.size.set(E,E);var Jl=new L.default(zc);Jl.size.set(E,E);var Tn=new L.default(Lc);Tn.size.set(E,E);var Ci=new L.default(Ic);Ci.size.set(E,E);var Ql=new L.default(qc);Ql.size.set(E,E);var pn=new L.default(Nc,new oe.default(0,0,E,E)),Ce=new L.default(Uc);Ce.size.set(S,S);var Sn=new L.default(Hc);Sn.size.set(S,S);var Mr=new L.default(Fn,new oe.default(0,0,S/2,S*1.5));Mr.origin.set(0,0);Mr.position.set(-S/2,0);var Ri=new L.default(Fn,new oe.default(S/2,0,S,S*1.5));Ri.origin.set(0,0);var Mi=new L.default(Fn,new oe.default(S*1.5,0,S/2,S*1.5));Mi.origin.set(0,0);var Nl=new L.default(Vc),Sr=new L.default(Gc);Sr.color=P.default.fromHex("#6D6D6D");var Di=P.default.fromHex("#E5B35B"),ql=P.default.fromHex("#f5ca7f"),Jc=P.default.fromHex("#99F3ED"),Qc=P.default.fromHex("#6AC2BC"),An=P.default.fromHex("#B84B4B"),Zl=new P.default(1.3,1.3,1.3,1),kt=new L.default(u.default.gfx.whiteTexture);kt.origin=new d.default(0,-8/(S*1.5));kt.size.set(S,S*1.5-16);kt.color=Jc;var Ft=new L.default(u.default.gfx.whiteTexture);Ft.origin=new d.default(0,-8/(S*1.5));Ft.size.set(S,S*1.5-16);Ft.color=Qc;var Cn=class{constructor(e,t){this.pos=e;this.time=t;this.sprite=new L.default(Yl,new oe.default(0,0,E*2,E*2)),this.sprite.position.copy(this.pos.add(1,1).mul(E))}sprite;draw(){let e=(u.default.gameTime.elapsed-this.time)/.15-.05;if(!(e<=0)){if(e>=1){_t=_t.filter(t=>t!==this);return}e=Math.floor(e*9),this.sprite.setSourceFromSpritesheet(new d.default(e%3,Math.floor(e/3)),new d.default(3,3)),u.default.gfx.drawSprite(this.sprite)}}},Rn=class{constructor(e,t){this.pos=e;this.time=t;this.sprite=new L.default(Yl,new oe.default(0,0,E*2,E*2)),this.sprite.position.copy(this.pos.add(1,1).mul(E))}sprite;draw(){let e=(u.default.gameTime.elapsed-this.time)/.1-.02;if(!(e<=0)){if(e>=1){_t=_t.filter(t=>t!==this);return}e=Math.floor(e*9),this.sprite.setSourceFromSpritesheet(new d.default(e%3,Math.floor(e/3)),new d.default(3,3)),this.sprite.size.mulSelf(.5),u.default.gfx.drawSprite(this.sprite)}}},te=class{constructor(e,t,i,s,n){this.dev_name=e;this.public_name=t;this.n_moves=i;this.n_delay=s;this.initial_state=n;n.wall.recalcFloors(n.spawner.pos)}},W=class{constructor(e,t,i){this.major_turn=e;this.minor_turn=t;this.things=i;this.empty=!1,this.someChanges=!0,this.won=!1,this.miniturn_siblings_count=-1}empty;someChanges;won;miniturn_siblings_count;draw(e){this.things.forEach(t=>t.draw(e)),this.spawner.draw(e)}playSounds(e){if(Tr||this.minor_turn<=0)return;let t=this.players[this.minor_turn-1];if(!t||!t.previous)return;t.previous.pos.equals(t.pos)?t.wall_crashed()&&(u.default.sfx.play(Yc,Math.pow(.6,t.index),1,!0),_t.push(new Rn(t.pos.add(t.dir.mul(.5)),u.default.gameTime.elapsed))):u.default.sfx.play(Wc,1.5*Math.pow(.6,t.index),1,!0),this.things.some(l=>!(l instanceof Nt)||l===t||!l.previous?!1:!l.previous.pos.equals(l.pos))&&u.default.sfx.play(Xc,.6*Math.pow(.6,t.index),1,!0);let s=this.target,n=this.crates,o=this.crates.filter(l=>l.previous&&!l.previous.pos.equals(l.pos)&&this.target.posAt(l.pos)),a=this.crates.some(l=>l.previous&&!l.previous.pos.equals(l.pos)&&this.target.posAt(l.previous.pos));o.length>0&&(u.default.sfx.play($c,.7,1,!0),o.forEach(l=>{_t.push(new Cn(l.pos,u.default.gameTime.elapsed))})),a&&u.default.sfx.play(Kc,.65,1,!0)}get wall(){let e=this.things.filter(t=>t instanceof Y);if(e.length===0)throw new Error("no walls!");if(e.length>1)throw new Error("too many walls!");return e[0]}get target(){let e=this.things.filter(t=>t instanceof K);if(e.length===0)throw new Error("no Targets!");if(e.length>1)throw new Error("too many Targets!");return e[0]}get spawner(){let e=this.things.filter(t=>t instanceof $);if(e.length===0)throw new Error("no Spawner!");if(e.length>1)throw new Error("too many Spawner!");return e[0]}get players(){return this.things.filter(e=>e instanceof si)}get crates(){return this.things.filter(e=>e instanceof b)}get buttons(){return this.things.filter(e=>e instanceof Ze)}get buttonTargets(){return this.things.filter(e=>e instanceof Br)}nextStates(){if(this.minor_turn!==0)throw new Error("this method should only be called on main states");let e=[],t=this;for(let s=0;s<t.players.length;s++){if(t.players[s].age>=D.length)continue;t=new W(t.major_turn,s+1,t.things.map(l=>l.clone()));let n=t.players[s];if(n.index!==s)throw console.log("cur_state.players:",t.players),console.log("new_player.index:",n.index),console.log("this.minor_turn:",this.minor_turn),new Error("new_player index is wrong! time to use the other way");let o=D[n.age],a=of([[ei.LEFT,d.default.left],[ei.RIGHT,d.default.right],[ei.UP,d.default.up],[ei.DOWN,d.default.down]],o);a!==null&&(t.move(n.pos,a),n.dir=a),n.age+=1,e.push(t)}if((this.major_turn+1)%Oe===0){t=new W(t.major_turn,t.minor_turn+1,t.things.map(o=>o.clone()));let s=t.spawner.dir,n=t.spawner.pos.add(s);t.move(n,s)&&t.things.push(new si(n,s.clone(),t.players.length,0,t.spawner)),e.push(t)}for(let s=0;s<t.buttons.length;s++){let n=t.buttons[s],{value:o,prev_value:a}=n.update(t);for(let l of n.target_ids)e=e.concat(t.buttonTargets[l].mainUpdate(t,o,a)),e.length>0&&(t=e.at(-1))}let i=new W(t.major_turn+1,0,t.things.map(s=>s.clone()));return i.empty=!0,e.forEach(s=>{s.miniturn_siblings_count=e.length}),i.someChanges=e.length>0,e.push(i),i.won=i.isWon(),e}move(e,t){return this.things.every(i=>i.move(this,e,t))}isWon(){let e=this.crates,t=this.target;return e.every(i=>t.posAt(i.pos))}},It=class{},Dn=class extends It{constructor(t,i){super();this.w=t;this.h=i;this.data=gn(t,i,!1),this.floor_data=gn(t,i,!1),this.floor_spr_1=new L.default(Il,new oe.default(0,0,E,E)),this.floor_spr_2=new L.default(Il,new oe.default(E,0,E,E))}previous=null;data;floor_data;floor_spr_1;floor_spr_2;static fromString(t){let i=t.trim().split(`
`).map(a=>a.trim()),s=i.length,n=i[0].length,o=new Dn(n,s);for(let a=0;a<s;a++)for(let l=0;l<n;l++){let h=i[a][l];o.data[a][l]=h==="#"}return o}draw(t){for(let i=0;i<=this.w;i++)for(let s=0;s<=this.h;s++){let n=this.wallAt(i-1,s-1)+this.wallAt(i,s-1)*2+this.wallAt(i-1,s)*4+this.wallAt(i,s)*8;(i+s)%2===1&&(n+=16),(this.floorAt(i-1,s-1)||this.floorAt(i,s-1)||this.floorAt(i-1,s)||this.floorAt(i,s))&&((i+s)%2===1?(this.floor_spr_1.position.set((i+.5)*E,(s+.5)*E),u.default.gfx.drawSprite(this.floor_spr_1)):(this.floor_spr_2.position.set((i+.5)*E,(s+.5)*E),u.default.gfx.drawSprite(this.floor_spr_2))),pn.setSourceFromSpritesheet(new d.default(n%4,Math.floor(n/4)),new d.default(4,8),1,!1),pn.position.set((i+.5)*E,(s+.5)*E),u.default.gfx.drawSprite(pn)}}wallAtPos(t){return!!(t.x<0||t.x>=this.w||t.y<0||t.y>=this.h||this.data[t.y][t.x])}wallAt(t,i){return t<0||t>=this.w||i<0||i>=this.h?0:this.data[i][t]?1:0}floorAt(t,i){return t<0||t>=this.w||i<0||i>=this.h?!1:this.floor_data[i][t]}recalcFloors(t){this.floor_data=gn(this.w,this.h,!1);let i=[t];for(;i.length>0;){let s=i.pop();this.floor_data[s.y][s.x]=!0;for(let n of[d.default.up,d.default.down,d.default.right,d.default.left]){let o=s.add(n);this.wallAtPos(o)||this.floorAt(o.x,o.y)||i.push(o)}}}move(t,i,s){return!this.wallAtPos(i)}clone(){return this}setAt(t,i){t.x<0||t.x>=this.w||t.y<0||t.y>=this.h||(this.data[t.y][t.x]=i)}},Y=Dn;zi(Y,"n_to_x",[]);var K=class extends It{constructor(t){super();this.positions=t}previous=null;draw(t){this.positions.forEach(i=>{Tn.position.set((i.x+1)*E,(i.y+1)*E),u.default.gfx.drawSprite(Tn)})}move(t,i,s){return!0}clone(){return this}toggleAt(t){let i=Bi(this.positions,s=>s.equals(t));i===-1?this.positions.push(t):this.positions.splice(i,1)}posAt(t){return this.positions.some(i=>i.equals(t))}},Bt=class extends It{constructor(t,i,s,n){super();this.pos=t;this.target_ids=i;this.active=s;this.previous=n}draw(t){Ci.position.copy(this.pos.add(1,1).mul(E)),t!==1&&this.previous&&this.previous.active!==this.active?Ci.color=P.default.lerp(Bt.ActiveColor,Bt.InactiveColor,this.active?t:1-t):Ci.color=this.active?Bt.ActiveColor:Bt.InactiveColor,u.default.gfx.drawSprite(Ci)}move(t,i,s){return!0}clone(){return new Bt(this.pos,this.target_ids,this.active,this)}update(t){let i=t.crates.some(n=>n.pos.equals(this.pos))||t.players.some(n=>n.pos.equals(this.pos))||t.spawner.pos.equals(this.pos),s=this.active;return this.active=i,{value:this.active,prev_value:s}}},Ze=Bt;zi(Ze,"ActiveColor",P.default.fromHex("#F0A863")),zi(Ze,"InactiveColor",P.default.fromHex("#4E3116"));var Br=class extends It{remove(e){let t=e.buttonTargets.indexOf(this);if(t===-1)throw new Error("removing a button target that doesn't exist");e.buttons.forEach(i=>{i.target_ids=i.target_ids.filter(s=>s!==t).map(s=>s<t?s:s-1)}),e.things=e.things.filter(i=>i!=this)}},Ge=class extends Br{constructor(t,i,s,n){super();this.pos=t;this.dir=i;this.extended=s;this.previous=n}mainUpdate(t,i,s){let n=new W(t.major_turn,t.minor_turn+1,t.things.map(o=>o.clone()));if(i){if(n.move(this.pos.add(this.dir),this.dir)){let o=n.things.find(a=>a instanceof Ge&&a.pos.equals(this.pos));return o.extended=!0,[n]}}else if(n.move(this.pos,this.dir.mul(-1))){let o=n.things.find(a=>a instanceof Ge&&a.pos.equals(this.pos));return o.extended=!1,[n]}return[]}draw(t){}move(t,i,s){return this.extended?!i.equals(this.pos.add(this.dir)):!i.equals(this.pos)}clone(){return new Ge(this.pos.clone(),this.dir.clone(),this.extended,this)}},Nt=class extends It{constructor(t,i){super();this.pos=t;this.previous=i}draw(t){t!==1&&this.previous?this.sprite.position.copy(d.default.lerp(this.previous.pos,this.pos,t).add(1,1).mul(E)):this.sprite.position.copy(this.pos.add(1,1).mul(E)),u.default.gfx.drawSprite(this.sprite)}move(t,i,s){if(!i.equals(this.pos))return!0;let n=i.add(s);return t.move(n,s)?(this.pos.copy(n),!0):!1}},$=class extends Nt{constructor(t,i,s){super(t,s);this.pos=t;this.dir=i;this.previous=s;this.sprite.rotation=this.dir.getRadians()}sprite=Ql;clone(){return new $(this.pos.clone(),this.dir.clone(),this)}},b=class extends Nt{sprite=Jl;clone(){return new b(this.pos.clone(),this)}},si=class extends Nt{constructor(t,i,s,n=0,o){super(t,o);this.pos=t;this.dir=i;this.index=s;this.age=n;this.previous=o}sprite=En;draw(t){this.sprite=this.age<D.length?En:Kl,this.sprite.rotation=this.dir.getRadians()+Math.PI/2,this.sprite.color=this.index===0?Zl:u.default.utils.Color.white,t!==1&&this.previous?N===0&&q<0?this.sprite.position.copy(d.default.lerp(this.pos.sub(this.dir),this.pos,t).add(1,1).mul(E)):(this.sprite.position.copy(d.default.lerp(this.previous.pos,this.pos,t).add(1,1).mul(E)),this.wall_crashed()&&this.sprite.position.copy(this.pos.add(this.dir.mul(t-t*t)).add(1,1).mul(E))):this.sprite.position.copy(this.pos.add(1,1).mul(E)),u.default.gfx.drawSprite(this.sprite)}wall_crashed(){return this.previous!==null&&this.previous.age!==this.age&&this.age>0&&this.age-1<D.length&&D[this.age-1]!==ei.NONE&&this.previous.pos.equals(this.pos)}clone(){return new si(this.pos.clone(),this.dir.clone(),this.index,this.age,this)}},Rt=[new te("first","sofa",17,4,new W(-1,0,[Y.fromString(`
                .###########
                .#.........#
                #########..#
                #.........##
            ...
            `),new K([new d.default(3,2),new d.default(4,2),new d.default(5,2),new d.default(6,2),new d.default(7,2),new d.default(8,2)]),new $(new d.default(1,1),d.default.down,null),new b(new d.default(3,4),null),new b(new d.default(4,4),null),new b(new d.default(5,4),null),new b(new d.default(6,4),null),new b(new d.default(7,4),null),new b(new d.default(8,4),null)])),new te("mini_avoid_avoiding","worm",7,3,new W(-1,0,[Y.fromString(`
                ...
                #.........##....
                ###########.....
            `),new K([new d.default(11,1),new d.default(13,3),new d.default(2,5)]),new $(new d.default(10,4),d.default.left,null),new b(new d.default(8,1),null),new b(new d.default(10,3),null),new b(new d.default(6,5),null)]))],eu=new Map;{let r=new d.default(6,3),e=0;for(let t of["sofa","cap","hat","soko","whale","house","stairs","snake","train","pipe","claw","toad","duck","car","factory","fish","chip","worm"]){let i=new L.default(jc);i.setSourceFromSpritesheet(new d.default(e%r.x,Math.floor(e/r.x)),r),i.position.set(e%Ie*Ve+Cr+ft/2,Math.floor(e/Ie)*Ve+Rr+ft/2),eu.set(t,i),e++}}var Dt=!1,_e=0,ei=(n=>(n[n.LEFT=0]="LEFT",n[n.RIGHT=1]="RIGHT",n[n.UP=2]="UP",n[n.DOWN=3]="DOWN",n[n.NONE=4]="NONE",n))(ei||{}),Ke=!1,Re=!1,Mt=!1,Oe=5,D=[],U=0,N=0,q=0,Pi=0,T,R,_t=[],et=d.default.zero,ie=0,Be=0,ct=new L.default(u.default.gfx.whiteTexture);ct.origin=d.default.zero;ct.color=Di;var zt=new L.default(u.default.gfx.whiteTexture);zt.origin=d.default.zero;zt.color=Di;var Mn=!1,ri=0,Bn;tu(Rt[ri]);var Ar=0;function tu(r){Bn=r,U=0,N=0,q=-.99,Pi=2,Ar=0,Oe=r.n_delay,iu(r.n_moves),T=r.initial_state.nextStates().at(-1),R=de(T,D),et=new d.default(T.wall.w,T.wall.h).mul(E).sub(pt).add(E,E).mul(.5),r.dev_name==="first"&&(et.y+=E*.5),Ke=!1,Re=!1,Mt=!1;for(let e in Qe)Qe[e]=1/0;Dt=!1,_t=[]}function Zc(){let r=T.wall,e=Math.floor((16-r.w)/2),t=Math.floor((9-r.h)/2),i=new Y(16,9);for(let s=0;s<r.w;s++)for(let n=0;n<r.h;n++)i.data[t+n][e+s]=r.data[n][s];T.things=T.things.map(s=>s instanceof Y?i:s instanceof Nt||s instanceof Ge||s instanceof Ze?(s.pos.addSelf(e,t),s):(s instanceof K&&s.positions.forEach(n=>{n.addSelf(e,t)}),s)),T.wall.recalcFloors(T.spawner.pos),U=0,N=0,q=0,Pi=2,R=de(T,D),et=new d.default(16,9).mul(E).sub(pt).add(E,E).mul(.5)}function iu(r,e=!1){if(e){for(;D.length>r;)D.pop();for(;D.length<r;)D.push(4)}else D=Array(r).fill(4);r<13?(ie=r,Be=0):(ie=Math.ceil(r/2),Be=r-ie),ct.position.set(-S*.5+8,8),ct.size.set(S*(ie+1)-16,S*1.5-16),Be>0&&(zt.position.set(-S*.5+8,8),zt.size.set(S*(Be+1)-16,S*1.5-16))}function de(r,e){let t=[r],i=r;for(let s=0;s<=U;s++)for(;;){let n=i.nextStates();if(t=t.concat(n),i=n.at(-1),i.major_turn!==s)break}return N+1>t.length&&(N=0),t}function Ul(r,e){switch(r){case 0:Ce.rotation=0,Ce.position.copy(e),u.default.gfx?.drawSprite(Ce);break;case 2:Ce.rotation=Math.PI*.5,Ce.position.copy(e),u.default.gfx?.drawSprite(Ce);break;case 1:Ce.rotation=Math.PI,Ce.position.copy(e),u.default.gfx?.drawSprite(Ce);break;case 3:Ce.rotation=Math.PI*1.5,Ce.position.copy(e),u.default.gfx?.drawSprite(Ce);break;case 4:Sn.position.copy(e),u.default.gfx?.drawSprite(Sn);break;default:break}}var ni=new L.default(u.default.gfx.whiteTexture);ni.origin=d.default.zero;ni.size=pt;var Je=u.default.gfx.createEffect(cr);u.default.gfx.useEffect(Je);Je.uniforms.u_aspect_ratio(ni.size.x/ni.size.y);var He=u.default.gfx.createEffect(yr);u.default.gfx.useEffect(He);He.uniforms.u_aspect_ratio(ke.size.x/ke.size.y);var ce=new L.default(u.default.gfx.whiteTexture);ce.origin=d.default.zero;ce.size=u.default.gfx.getCanvasSize();var pe=u.default.gfx.createEffect(br);u.default.gfx.useEffect(pe);pe.uniforms.u_screen_size(ce.size.x,ce.size.y);u.default.gfx.useEffect(null);var Pt=[];function ef(r){let e=new L.default(u.default.gfx.whiteTexture);e.origin=new d.default(0,-8/(S*1.5)),e.size.set(S,S*1.5-16),r<ie?e.position.set(r*S,0):e.position.set((r-ie)*S,0),e.color=An,Pt.push([e,.15,r<ie])}function Hl(r,e){for(var t=Pt.length-1;t>=0;t--){let[i,s,n]=Pt[t];n!==e&&(u.default.gfx.drawSprite(i),s-=r,s<=0?Pt.splice(t,1):Pt[t][1]=s)}}var ze=0,tf=function(){return u.default.gfx.buildText(Le,`WASD to
...
change turn`,32,P.default.white,ae.TextAlignments.Center).position.set(690,290),u.default.gfx.buildText(Le,"Space to wait",32,P.default.white,ae.TextAlignments.Center).position.set(400,410),u.default.gfx.buildText(Le,"R to restart, Esc. to select level",28,P.default.white,ae.TextAlignments.Center).position.set(400,550),u.default.gfx.buildText(Le,"Q/Z",32,P.default.lightgrey,ae.TextAlignments.Center).position.set(30,420),u.default.gfx.buildText(Le,"E/X",32,P.default.lightgrey,ae.TextAlignments.Center).position.set(770,420),function(){Dt||Mt||ri===0&&(ti.sourceRect.y=u.default.gameTime.elapsed%2<1?0:100,ii.sourceRect.y=u.default.gameTime.elapsed%2<1?0:50,ti.position.set(400,360),$e.position.set(150,385),ii.position.set(650,385),u.default.gfx.drawSprite(ti),u.default.gfx.drawSprite($e),u.default.gfx.drawSprite(ii))}}(),he=0,Jt=-1;function ru(){switch(u.default.startFrame(),u.default.gfx.clear(u.default.utils.Color.darkslategray),u.default.input.pressed("m")&&(Tr=!Tr,Zt.sourceRect.y=Tr?0:50,Zt.size.mulSelf(1.25),Zt.rotation=(Math.random()-.5)*.2,new wn.default(Zt).to({"size.x":100,"size.y":50,rotation:0}).duration(.1).play()),u.default.input.pressed("b")&&(_n=!_n),u.default.gfx.useEffect(Je),_n||Je.uniforms.u_time(u.default.gameTime.elapsed),Je.uniforms.u_alpha(1),u.default.gfx.drawSprite(ni),u.default.gfx.useEffect(null),_e===0&&(ke.color.a=1),u.default.gfx.useEffect(He),He.uniforms.u_time(u.default.gameTime.elapsed),He.uniforms.u_alpha(1),He.uniforms.u_dark(1),u.default.gfx.drawSprite(ke),u.default.gfx.useEffect(null),U>=D.length&&(ce.color=new P.default(0,0,0,.4),u.default.gfx.drawSprite(ce)),_e){case 1:q===0&&!Re&&u.default.input.pressed(["escape","p"])&&(ze=ri,_e=2);break;case 2:u.default.input.pressed(["escape","p"])?_e=1:(u.default.input.pressed(["enter","space"])||u.default.input.mousePressed())&&jl(ze);break;default:break}if(_e===1&&!Dt){kn(["q","z"],u.default.gameTime.delta)&&U>0?((Ke||Re)&&rf(),U-=1):kn(["e","x"],u.default.gameTime.delta)&&(Ke||Re?Ke=!1:(U+=1,U>=R.at(-1).major_turn&&(R=de(T,D)))),!Re&&u.default.input?.pressed(["r"])&&(U=0,dt.instant_reset&&(N=0,q=-.99,D=D.fill(4),R=de(T,D))),q===0&&dt.time==="AUTO"&&R[N].major_turn>=D.length&&R[N].minor_turn==0&&R[N].someChanges&&!R[N].won&&(U+=1,U>=R.at(-1).major_turn&&(R=de(T,D))),u.default.input?.pressed(["t"])&&(console.log("cur_turn: ",N),console.log("selected_turn: ",U),console.log("cur_state: ",R[N]),console.log("all states: ",R));let r=Vl([[["w","up"],2],[["s","down"],3],[["d","right"],1],[["a","left"],0],["space",4]],u.default.gameTime.delta);if(r!==null)if(Ke||Re)Ke=!1;else if(U<D.length)D[U]=r,ef(U),U+=1,R=de(T,D);else if(r===4)U+=1,U>=R.at(-1).major_turn&&(R=de(T,D));else if(dt.time==="MANUAL"){Ar+=1;let e=.1,t=Bn.dev_name==="first";t?($e.color=Zl,$e.size.mulSelf(1.15),$e.rotation=(Math.random()-.5)*.2,new wn.default($e).to({"size.x":200,"size.y":50,rotation:0}).duration(.1).play()):(ct.color=An,zt.color=An),xi(()=>(t||(u.default.gfx.setCameraOrthographic(new d.default(-400+.5*ie*S,-445)),u.default.gfx.drawSprite(ct),Be>0&&(u.default.gfx.setCameraOrthographic(new d.default(-400+.5*Be*S,-445-75)),u.default.gfx.drawSprite(zt)),u.default.gfx.resetCamera()),e-=u.default.gameTime.delta,e<0?(Ar-=1,Ar===0&&(ct.color=Di,zt.color=Di,$e.color=P.default.white),!0):!1))}else dt.time==="SEMI"&&(U+=1,U>=R.at(-1).major_turn&&(R=de(T,D)))}if(u.default.gfx.setCameraOrthographic(et),q<0?R[N].draw(Qt((q+1)/(1-fn),0,1)):q>0?R[N+1].draw(Qt((q-fn)/(1-fn),0,1)):R[N].draw(1),_t.forEach(r=>r.draw()),_e===1&&Mt&&!Dt){let r=u.default.input.mousePosition.add(et).div(E).round().sub(1,1);if(u.default.gfx.outlineRect(new oe.default((r.x+.5)*E,(r.y+.5)*E,E,E),u.default.utils.Color.white),u.default.input?.mouseDown(je.MouseButtons.left)&&(T.wall.setAt(r,!0),T.wall.recalcFloors(T.spawner.pos),R=de(T,D)),u.default.input?.mouseDown(je.MouseButtons.right)&&(T.wall.setAt(r,!1),T.wall.recalcFloors(T.spawner.pos),R=de(T,D)),u.default.input?.mouseWheelSign!==0){if(u.default.input.shiftDown){let e=Qt(D.length+u.default.input?.mouseWheelSign,2,30);iu(e,!0)}else Oe+=u.default.input?.mouseWheelSign,Oe=Math.max(1,Oe);R=de(T,D)}if(u.default.input.keyPressed(je.KeyboardKeys.n1)){let e=Bi(T.things,t=>t instanceof b&&t.pos.equals(r));e===-1?T.things.push(new b(r,null)):T.things.splice(e,1),R=de(T,D)}if(u.default.input.keyPressed(je.KeyboardKeys.n2)&&T.target.toggleAt(r),u.default.input.keyPressed(je.KeyboardKeys.n3)&&(T.spawner.pos=r,T.spawner.dir=Gl(u.default.input.mousePosition.add(et).div(E).sub(1,1).sub(r)),T.spawner.sprite.rotation=T.spawner.dir.getRadians(),T.players[0].pos=T.spawner.pos.add(T.spawner.dir),T.players[0].dir=T.spawner.dir.clone(),R=de(T,D)),u.default.input.keyPressed(je.KeyboardKeys.n4)){let e=Bi(T.things,t=>t instanceof Ge&&t.pos.equals(r));e===-1?T.things.push(new Ge(r,Gl(u.default.input.mousePosition.add(et).div(E).sub(1,1).sub(r)),!1,null)):(console.log(e),T.things[e].remove(T),console.log(T)),R=de(T,D)}if(u.default.input.keyPressed(je.KeyboardKeys.n5)){let e=Bi(T.things,t=>t instanceof Ze&&t.pos.equals(r));e===-1?T.things.push(new Ze(r,[],!1,null)):T.things.splice(e,1),R=de(T,D)}if(u.default.input.keyPressed(je.KeyboardKeys.n6)){if(Jt===-1)Jt=Bi(T.things,e=>e instanceof Ze&&e.pos.equals(r));else{let e=T.buttonTargets.findIndex(t=>t instanceof Ge&&t.pos.equals(r));if(e!==-1){let t=T.things[Jt];t.target_ids.includes(e)?t.target_ids=t.target_ids.filter(i=>i!=e):t.target_ids.push(e)}Jt=-1}R=de(T,D)}if(Jt!==-1){let e=T.things[Jt];u.default.gfx.fillRect(new oe.default((e.pos.x+.5)*E,(e.pos.y+.5)*E,E,E),e.active?u.default.utils.Color.red:u.default.utils.Color.green)}}u.default.gfx.setCameraOrthographic(new d.default(-400+.5*ie*S,-445)),u.default.gfx.drawSprite(ct),Oe<ie&&u.default.gfx.fillRect(new oe.default(Oe*S,8,S,S*1.5-16),ql);for(let r=U;r>=0;r-=Oe)r>=ie||(r===U?Pt.length===0&&(kt.position.set(r*S,0),u.default.gfx.drawSprite(kt)):(Ft.position.set(r*S,0),u.default.gfx.drawSprite(Ft)));Hl(u.default.gameTime.delta,!1),u.default.gfx.drawSprite(Mr),Mi.position.set(ie*S,0),u.default.gfx.drawSprite(Mi);for(let r=0;r<ie;r++){Ri.position.set(r*S,0),u.default.gfx.drawSprite(Ri);let e=D[r];Ul(e,new d.default((r+.5)*S,S*.75))}if(Be>0){u.default.gfx.setCameraOrthographic(new d.default(-400+.5*Be*S,-445-75)),u.default.gfx?.fillRect(new oe.default(-S*.5+8,8,S*(Be+1)-16,S*1.5-16),Di),Oe>=ie&&u.default.gfx.fillRect(new oe.default((Oe-ie)*S,8,S,S*1.5-16),ql);for(let r=U;r>=ie;r-=Oe)r>=ie+Be||(r===U?Pt.length===0&&(kt.position.set((r-ie)*S,0),u.default.gfx.drawSprite(kt)):(Ft.position.set((r-ie)*S,0),u.default.gfx.drawSprite(Ft)));Hl(u.default.gameTime.delta,!0),u.default.gfx.drawSprite(Mr),Mi.position.set(Be*S,0),u.default.gfx.drawSprite(Mi);for(let r=0;r<Be;r++){Ri.position.set(r*S,0),u.default.gfx.drawSprite(Ri);let e=D[r+ie];Ul(e,new d.default((r+.5)*S,S*.75))}}if(u.default.gfx.resetCamera(),Dt&&(u.default.gfx.useEffect(Je),Je.uniforms.u_aspect_ratio(ce.size.x/ce.size.y),u.default.gfx.drawSprite(ce),u.default.gfx.useEffect(null),u.default.gfx.useEffect(u.default.gfx.builtinEffects.MsdfFont),u.default.gfx.drawGroup(Ot("Thanks for",400,75,112,ki,ae.TextAlignments.Center,Fi),!1),u.default.gfx.drawGroup(Ot("playing!",400,200,112,ki,ae.TextAlignments.Center,Fi),!1),u.default.gfx.drawGroup(Ot("- knexator",600,450,42,ki,ae.TextAlignments.Center,Fi),!1),u.default.gfx.useEffect(null)),_e===1&&!Dt){let r=u.default.gameTime.delta;for(;r>0;){if(N===0&&q<0){q=Lt(q,0,r*4);break}if(q<0?R[N].empty&&(q=0):q>0&&R[N+1].empty&&(q=0),q!==0){let e=Math.abs(R[N].major_turn-U);q>0&&e++;let t=1;for(let a=1;a<e;a++)t*=Ac;let i=R[q>0?N+1:N].miniturn_siblings_count,s=Math.min(Cc/i,1),n=1;dt.time==="AUTO"&&U>=D.length?(n*=Pi,Pi+=u.default.gameTime.delta):Pi=1.5;let o=n/(s*Rc*t);r-=Math.abs(q/o),q=Lt(q,0,u.default.gameTime.delta*o)}if(q===0&&(R[N].major_turn!==U||R[N].minor_turn!==0)){let e=Math.sign(U-R[N].major_turn-.5);N+=e,q-=e*.99,e>0&&R[N].playSounds(1),!Mt&&!Re&&R[N].won&&!Ke&&(Ll.setItem(Bn.dev_name,"y"),q=0,U=R[N].major_turn,Ke=!0)}if(q===0)break}!Re&&!Mt&&u.default.input.pressed("dash")&&(Mt=!0,Zc()),!Mt&&!Re&&q===0&&R[N].won&&(ri<Rt.length-2?jl(ri+1):su(()=>nf()))}if(tf(),_e===2){ce.color=new P.default(0,0,0,.7),u.default.gfx.drawSprite(ce);let r=Vl([[["w","up"],-Ie],[["s","down"],Ie],[["d","right"],1],[["a","left"],-1]],u.default.gameTime.delta);if(r!==null&&(ze=af(ze+r,Rt.length)),u.default.input.mouseDelta.length>0){let e=Math.floor((u.default.input.mousePosition.x-Cr+13)/Ve),t=Math.floor((u.default.input.mousePosition.y-Rr+13)/Ve);e=Qt(e,0,Ie-1),t=Qt(t,0,2),ze=t*Ie+e}for(let e=0;e<Rt.length;e++){let t=Ll.getItem(Rt[e].dev_name)==="y",i=eu.get(Rt[e].public_name);i?(Nl.position.copy(i.position),Sr.position.copy(i.position),Sr.color=t?e===ze?P.default.chartreuse:P.default.darkgreen:e===ze?P.default.cyan:P.default.darkcyan,u.default.gfx.drawSprite(Nl),u.default.gfx.drawSprite(i),u.default.gfx.drawSprite(Sr)):u.default.gfx.fillRect(new oe.default(e%Ie*Ve+Cr,Math.floor(e/Ie)*Ve+Rr,ft,ft),t?e===ze?P.default.chartreuse:P.default.darkgreen:e===ze?P.default.cyan:P.default.darkcyan)}u.default.gfx.useEffect(He),He.uniforms.u_dark(.7),u.default.gfx.drawSprite(ke),u.default.gfx.useEffect(null),ti.sourceRect.y=u.default.gameTime.elapsed%2<1?0:100,ii.sourceRect.y=u.default.gameTime.elapsed%2<1?0:50,ti.position.set(400,525),$e.position.set(150,550),ii.position.set(150,485),u.default.gfx.drawSprite(ti),u.default.gfx.drawSprite($e),u.default.gfx.drawSprite(ii),u.default.gfx.drawSprite(Zt),u.default.gfx.drawSprite($l)}_e===0&&(he>0&&(he+=u.default.gameTime.delta*1.5,he>.5&&(q=Lt(q,0,u.default.gameTime.delta*4)),he>=1&&(_e=1)),u.default.gfx.useEffect(Je),Je.uniforms.u_alpha(1-he*he),u.default.gfx.drawSprite(ni),u.default.gfx.useEffect(He),He.uniforms.u_alpha(1-he*he),u.default.gfx.drawSprite(ke),u.default.gfx.useEffect(u.default.gfx.builtinEffects.MsdfFont),yn.position.y=mn(10,-400+10,he*he),bn.position.y=mn(136,-400+136,he*he),u.default.gfx.drawGroup(yn,!1),u.default.gfx.drawGroup(bn,!1),he===0?(vn._sprites.forEach(r=>{r.color.a-=u.default.gameTime.delta*2}),vr._sprites.forEach(r=>{r.color.a=Qt(u.default.gameTime.elapsed-.8,0,1)})):(vr._sprites.forEach(r=>{r.color.a-=u.default.gameTime.delta}),vr.position.y=mn(490,690,he*he)),u.default.gfx.drawGroup(vn,!1),u.default.gfx.drawGroup(vr,!1),u.default.gfx.useEffect(null),_e===1&&(ke.color.a=1),(u.default.input.anyKeyPressed||u.default.input.anyMouseButtonPressed)&&(he+=1e-4)),ll(),u.default.endFrame(),u.default.requestAnimationFrame(ru)}function rf(){console.log("cancelling!"),Mn=!0,Ke=!1,Re=!1}function su(r){let e=0,t=1;if(Re=!0,u.default.gfx.useEffect(pe),_e===1){let i=1,s=R[N-i];for(;s.minor_turn!==0;)i++,s=R[N-i];let n=s.crates,a=s.target.positions.filter(h=>n.every(c=>!c.pos.equals(h)));if(a.length===0)throw new Error("idk targets thing");let l=a[0].add(1,1).mul(E).sub(et);pe.uniforms.u_pos(l.x,l.y)}else _e===2&&(pe.uniforms.u_pos(ze%Ie*Ve+Cr+ft/2,Math.floor(ze/Ie)*Ve+Rr+ft/2),e=.25,t=1.5);u.default.gfx.useEffect(null),xi(()=>{if(u.default.gfx.useEffect(pe),pe.uniforms.u_progress(e),u.default.gfx.drawSprite(ce),u.default.gfx.useEffect(null),Mn){if(e=Lt(e,0,u.default.gameTime.delta*3/xn),e<=0)return Mn=!1,!0}else if(e=Lt(e,1,u.default.gameTime.delta*t/xn),e>=1)return Re=!1,r(),!0;return!1})}function sf(r){let e=0;_e=1,ri=r,tu(Rt[r]),u.default.gfx.useEffect(pe);let t=T.spawner,i=t.pos.add(t.dir.mul(.5)).add(1,1).mul(E).sub(et);pe.uniforms.u_pos(i.x,i.y),u.default.gfx.useEffect(null),xi(()=>(u.default.gfx.useEffect(pe),pe.uniforms.u_progress(1-e),u.default.gfx.drawSprite(ce),u.default.gfx.useEffect(null),e=Lt(e,1,u.default.gameTime.delta/xn),e>=1))}function nf(){let r=0;Dt=!0,u.default.gfx.useEffect(pe),pe.uniforms.u_pos(ce.size.x/2,ce.size.y/2),u.default.gfx.useEffect(null),xi(()=>(u.default.gfx.useEffect(pe),pe.uniforms.u_progress(1-r),u.default.gfx.drawSprite(ce),u.default.gfx.useEffect(null),r=Lt(r,1,u.default.gameTime.delta*3),r>=1))}function jl(r){su(()=>sf(r))}var Qe={},Er={};function kn(r,e){if(Re&&_e===2)return!1;let t=Array.isArray(r)?r.join(""):r;if(t in Qe||(Qe[t]=0,Er[t]=0),Qe[t]=Math.max(0,Qe[t]-e),u.default.input.down(r)){if(Qe[t]==0)return Er[t]+=1,Qe[t]=Er[t]==1?.22:.08,!0}else return Er[t]=0,Qe[t]=0,!1;return!1}function Lt(r,e,t){return e>r?Math.min(r+t,e):e<r?Math.max(r-t,e):e}function gn(r,e,t){let i=[];for(let s=0;s<e;s++){let n=[];for(let o=0;o<r;o++)n.push(t);i.push(n)}return i}function of(r,e){for(let[t,i]of r)if(t===e)return i;return null}function Vl(r,e){for(let[t,i]of r)if(kn(t,e))return i;return null}function Bi(r,e){for(let t=0;t<r.length;t++)if(e(r[t]))return t;return-1}function Gl(r){return Math.abs(r.x)>Math.abs(r.y)?r.x>=0?d.default.right:d.default.left:r.y>=0?d.default.down:d.default.up}function Qt(r,e,t){return r<e?e:r>t?t:r}function mn(r,e,t){return r*(1-t)+e*t}function af(r,e){return(r%e+e)%e}Xl.default.reset();ru();
/**
